...
from .views import AnalyzeURLView , AnalysisHistoryListView , AnalysisHistoryDetailView, DashboardDataView, IgnoreRecommendationView
...
urlpatterns = [
    ...
    path('ignore/', IgnoreRecommendationView.as_view(), name='ignore-recommendation'),
]